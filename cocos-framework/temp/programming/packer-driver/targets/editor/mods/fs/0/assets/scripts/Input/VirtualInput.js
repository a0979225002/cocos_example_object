System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Input, VirtualInput, VirtualInputNode, _crd, OverlapBehavior;
  ...
  _export({
    VirtualInput: void 0,
    VirtualInputNode: void 0,
    OverlapBehavior: void 0
  });
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("VirtualInput", VirtualInput = class VirtualInput {
        constructor() {
      ...
      _export("VirtualInputNode", VirtualInputNode = class VirtualInputNode {
        update() {}
