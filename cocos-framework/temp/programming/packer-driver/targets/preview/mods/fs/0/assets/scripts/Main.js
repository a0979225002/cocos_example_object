  ...
  return {
    ...
    execute: function () {
      ...
      _export("Main", Main = (_dec = ccclass('Main'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.setupSceneSelector = function setupSceneSelector() {
          var _find,
              _this = this;

          var checkBox = (_find = find("Canvas_UI/Layout/DebugRender")) === null || _find === void 0 ? void 0 : _find.getComponent(Toggle);

          if (checkBox) {
            checkBox.isChecked = es.Core.debugRenderEndabled;
            checkBox.node.on('toggle', function (toggle) {
              es.Core.debugRenderEndabled = toggle.isChecked;
            }, this);
          }

          var layout = find("Canvas_UI/Layout");
          (_crd && sampleList === void 0 ? (_reportPossibleCrUseOfsampleList({
            error: Error()
          }), sampleList) : sampleList).forEach(function (value, key) {
            resources.load('prefabs/Button', Prefab, function (err, data) {
              var _buttonNode$getChildB;

              var buttonNode = instantiate(data);
              layout === null || layout === void 0 ? void 0 : layout.addChild(buttonNode);
              var label = (_buttonNode$getChildB = buttonNode.getChildByName("Label")) === null || _buttonNode$getChildB === void 0 ? void 0 : _buttonNode$getChildB.getComponent(Label);
