  ...
  (function () {
    ...
    !function (t) {
      var e = function () {
        ...
        return Object.defineProperty(e, "Instance", {
          ...
          set: function (e) {
            t.Insist.isNotNull(e, "场景不能为空"), null == this._instance._scene ? (this._instance._scene = e, this._instance.onSceneChanged(), this._instance._scene.begin()) : this._instance._nextScene = e;
          },
          enumerable: !0,
          configurable: !0
        }), e.create = function (e) {
      ...
      var e = function () {
        ...
        return e.prototype.initialize = function () {}, e.prototype.onStart = function () {}, e.prototype.unload = function () {}, e.prototype.begin = function () {
          ...
          t.Insist.isTrue(n.contains(e), "SceneComponent" + e + "不在SceneComponents列表中!"), n.remove(e), e.onRemovedFromScene();
          ...
          t.Insist.isFalse(new t.List(this.entities.buffer).contains(e), "您试图将同一实体添加到场景两次: " + e), this.entities.add(e), e.scene = this;
      ...
      var e = function (e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "mass", {
          ...
          t.Debug.warnIf(null == this._collider, "ArcadeRigidbody 没有 Collider。ArcadeRigidbody需要一个Collider!");
        }, n.prototype.update = function () {
          var e, i;
      ...
      var e = function (e) {
        ...
        return __extends(n, e), n.prototype.onAddedToEntity = function () {
          ...
          this._collider = e, t.Debug.warnIf(null == this._collider, "ProjectileMover没有Collider。ProjectilMover需要一个Collider!");
      ...
      var e = function () {
        ...
        return Object.defineProperty(e.prototype, "count", {
          ...
          t.Insist.isFalse(!!i.find(function (t) {
            return t == e;
          }), "组件renderLayer列表已包含此组件"), i.push(e);
    ...
    var StringUtils = function () {
      ...
      return t.matchChineseWord = function (t) {
        ...
        for (var n = 0, i = e.length; n < i; n++) null != e[n] && "" != e[n] || (e[n] = "无"), t = t.replace("{" + n + "}", e[n]);
    ...
    !function (t) {
      ...
      var e = function () {
        ...
        return e.reset = function () {
          ...
          return void 0 === i && (i = e.allLayers), 0 == n.length ? (console.warn("传入了一个空的结果数组。不会返回任何结果"), 0) : this._spatialHash.overlapRectangle(t, n, i);
      ...
      var e = function () {
        ...
        return e.prototype.register = function (e) {
          ...
          for (var n = e.registeredPhysicsBounds.clone(), i = this.cellCoords(n.x, n.y), r = this.cellCoords(n.right, n.bottom), o = i.x; o <= r.x; o++) for (var s = i.y; s <= r.y; s++) {
            ...
            t.Insist.isNotNull(a, "从不存在碰撞器的单元格中移除碰撞器: [" + e + "]"), null != a && new t.List(a).remove(e);
          }
          ...
          try {
            for (var c = __values(a), h = c.next(); !h.done; h = c.next()) {
              ...
              if (u instanceof t.BoxCollider) n[s] = u, s++;else if (u instanceof t.CircleCollider) t.Collisions.rectToCircle(e, u.bounds.center, .5 * u.bounds.width) && (n[s] = u, s++);else {
                if (!(u instanceof t.PolygonCollider)) throw new Error("overlapRectangle对这个类型没有实现!");
          ...
          try {
            for (var u = __values(h), l = u.next(); !l.done; l = u.next()) {
              ...
              if (p instanceof t.BoxCollider) p.shape.overlaps(this._overlapTestCircle) && (i[c] = p, c++);else if (p instanceof t.CircleCollider) p.shape.overlaps(this._overlapTestCircle) && (i[c] = p, c++);else {
                if (!(p instanceof t.PolygonCollider)) throw new Error("对这个对撞机类型的overlapCircle没有实现!");
      ...
      var n = function () {
        ...
        return n.prototype.addObserver = function (n, i, r) {
          ...
          o || (o = [], this._messageTable.set(n, o)), t.Insist.isFalse(-1 != o.findIndex(function (t) {
            return t.func == i;
          }), "您试图添加相同的观察者两次"), o.push(new e(i, r));
          ...
          for (var i = e.hash(n), r = e.reduce(i, this._buckets.length), o = t.NumberExtension.toNumber(this._buckets[r]) - 1; -1 != o;) {
            if (this._valuesInfo[o].hashcode == i && this._valuesInfo[o].key == n) {
              if (this._buckets[r] - 1 == o) {
                if (-1 != this._valuesInfo[o].next) throw new Error("如果 bucket 指向单元格，那么 next 必须不存在。");
                var s = this._valuesInfo[o].previous;
                this._buckets[r] = s + 1;
              } else if (-1 == this._valuesInfo[o].next) throw new Error("如果 bucket 指向另一个单元格，则 NEXT 必须存在");
      ...
      var e = function () {
        ...
        return t.randrange = function (t, e, n) {
          if (void 0 === n && (n = 1), 0 == n) throw new Error("step 不能为 0");
          var i = e - t;
          if (0 == i) throw new Error("没有可用的范围(" + t + "," + e + ")");
          i < 0 && (i = t - e);
