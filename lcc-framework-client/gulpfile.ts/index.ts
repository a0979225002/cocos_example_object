...
export default function build(cb:Function){
	...
	console.log("构建资源框架\t", "buildAssetFramework");
	console.log("构建发布框架\t", "buildPublishFramework");
	console.log("构建包声明\t", "buildDeclaration [--pack NAME]");
	cb();
}

export { build as buildExtension } from "./extension";
export { buildAsset as buildAssetFramework, buildPublish as buildPublishFramework } from "./framework";
