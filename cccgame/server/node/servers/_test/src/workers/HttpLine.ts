 ...
 * 测试 - HttpLine
 */
export default class HttpLine extends lcc.WorkerBase {

    private _serverLine:lcc.NetLine = null;
	
    public async onStart(){
        this._serverLine = lcc.netServer.addServer('test-httpline', lcc.NetLineType.HTTP, {
            port : PORT
        });
    ...
    public async onStop(){
        lcc.netServer.removeServer('test-httpline');
    }
}
